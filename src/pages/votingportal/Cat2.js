...
export function Cat2(){
    ...
    let category='Finance',candidate1={name:'Niwamanya James',img:cand1img},candidate2={name:'Nalubega Latifah',img:cand1img}
...
<div class="radioCont1">
        ...
        <p></p>
        <a href="/pages/votingportal/confirm"><div class="button1">Next page</div></a>
